...
// Ce fichier contient un tableau listant l'intégralité des articles
// Sous la forme
// $articles = [
//     1 => infos article 1..
//     2 => infos article 2..
...
$articles = [
    ...
    3 => [
        ...
        'text'     => 'Vero blanditiis nisi veritatis id perferendis, quod quaerat necessitatibus ullam nobis quidem ipsam optio sit',
        'category' => 'news',
        'date'     => 'le 5 mai 2018',
        'icon'     => 'icon-ohz.png'
    ],
    4 => [
        ...
        'author'   => 'Jack Sparrow',
        'text'     => 'Zombie, nam rick grimes malum cerebro. De carne lumbering animata corpora quaeritis. Summus brains sit​​, morbo vel maleficia? De apocalypsi gorger omero undead survivor dictum mauris. Hi mindless mortuis soulless creaturas, imo evil stalking monstra adventus resi dentevil vultus comedat cerebella viventium. Qui animated corpse, cricket bat max brucks terribilem incessu zomby. The voodoo sacerdos flesh eater, suscitat mortuos comedere carnem virus',
        'category' => 'work',
        'date'     => 'le 31 juillet 2018',
        'icon'     => 'icon-spr.png'
    ],
    5 => [
